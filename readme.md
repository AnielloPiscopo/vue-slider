...
| File                                                                                 | Summary                   |
| ---                                                                                  | ---                       |
| [index.html](https://github.com/AnielloPiscopo/vue-slider/blob/main/index.html)      | HTTPStatus Exception: 429 |
| [script.js](https://github.com/AnielloPiscopo/vue-slider/blob/main/js\script.js)     | HTTPStatus Exception: 429 |
| [style.css](https://github.com/AnielloPiscopo/vue-slider/blob/main/styles\style.css) | HTTPStatus Exception: 429 |
...
1. Clone the vue-slider repository:
```sh
